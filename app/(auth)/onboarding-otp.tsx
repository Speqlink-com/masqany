 ...
 * Font: Nunito throughout. CG-Bold for title.
 * Digit boxes: Nunito_800ExtraBold — clean, heavy number rendering.
 */
  ...
  return (
    <AuthLayout>
      ...
      <View style={{ flex: 1, paddingHorizontal: 24, paddingTop: 24, paddingBottom: 48 }}>
        ...
        <Text className="font-cg-bold text-dark-400 mb-2" style={{ fontSize: 26 }}>
          {step === "email" ? "Verify your email" : "Verify your phone"}
        </Text>
        <Text style={{ fontFamily: "Nunito_400Regular", fontSize: 15, color: "#4F5C62", lineHeight: 24, marginBottom: 36 }}>
          We sent a 6-digit code to{" "}
          <Text style={{ fontFamily: "Nunito_700Bold", color: "#1A2225" }}>{destination}</Text>.
          {" "}Enter it below.
        </Text>
        ...
        {error && (
          <Text style={{ fontFamily: "Nunito_400Regular", fontSize: 14, color: "#F75555", textAlign: "center", marginTop: 16 }}>
            {error}
          </Text>
        )}
        ...
        <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", marginTop: 24, marginBottom: 36 }}>
          <Text style={{ fontFamily: "Nunito_400Regular", fontSize: 14, color: "#4F5C62" }}>
            Didn't receive it?{" "}
          </Text>
          {cd.canResend ? (
            <TouchableOpacity onPress={() => { cd.reset(); setDigits(Array(6).fill("")); setError(null); }} activeOpacity={0.7}>
              <Text style={{ fontFamily: "Nunito_700Bold", fontSize: 14, color: "#20A6FD", textDecorationLine: "underline" }}>
                Resend code
              </Text>
            </TouchableOpacity>
          ) : (
            <Text style={{ fontFamily: "Nunito_600SemiBold", fontSize: 14, color: "#BDBDC0" }}>
              Resend in {cd.secs}s
            </Text>
          )}
        </View>
        ...
        <Text style={{ fontFamily: "Nunito_400Regular", fontSize: 12, color: "#BDBDC0", textAlign: "center", marginTop: 20 }}>
